...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/startnow.css">
...
<body>
    ...
    <img src="img/logo/capture.png" alt="logo" class="center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 wow fadeInLeft">
                    ...
                    <div class="about-item text-center">
                        ...
                        <hr><br>
                        <div id="home-btn">
                            <a class="btn btn-general btn-home " href="login1.php" title="Login" role="button">Login</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12 wow fadeInUp" data-wow-duration="2s">
                    ...
                    <div class="about-item text-center">
                        ...
                        <hr><br>
                        <div id="home-btn">
                            <a class="btn btn-general btn-home " href="register.php" title="Register" role="button">Register</a>
                        </div>
                      </div>
                </div>
